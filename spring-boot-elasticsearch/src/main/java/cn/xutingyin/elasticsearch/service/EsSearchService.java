...
public interface EsSearchService {
     ...
     * @return
     */
    boolean isExistDocument(String index, String id) throws IOException;
     ...
     * @throws IOException
     */
    boolean bulkAddDocument(List<User> list, String index, String id) throws IOException;
     ...
     */
    List<Map<String, Object>> termQuery(String index, TreeMap<String, Object> content, int size, int from,
     ...
     * @throws IOException
     */
    List<Map<String, Object>> boolmustQuery(String index, TreeMap<String, Object> content, int size, int from)
        throws IOException;
}
